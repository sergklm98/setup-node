---
description: Use when working with memory bank MCP tools, managing persistent context, or following memory bank lifecycle patterns across sessions
# applyTo: "**"  # Apply to all files since memory bank is session-persistent
---
